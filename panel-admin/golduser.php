                 ...
                 with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="golduser.php" class="nav-link active">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>کاربران ویژه</p>
                                </a>
                            </li>
...
<div>
    <h1 style="margin-right: 280px; margin-top: 12px; opacity: 0.7;">حساب ویژه</h1>
</div>
<div class="form-menus" style="width: 70%; margin-right: 280px; margin-top: 20px;">
    <form method="POST">
        <label>قیمت اشتراک ماهانه (تومان)</label>
        <input type="text" name="username" class="form-control" placeholder="اشتراک ماهانه" value="<?= $pa['pay'] ?>000"><br>

        <div style="display: flex; justify-content: center;">
            <input type="submit" value="ثبت قیمت" name="register" class="btn btn-warning" style="width: 60%;">
        </div>
    </form><br>
</div>
